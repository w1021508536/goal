...
import com.pi.small.goal.my.entry.NoticeEntity;
import com.pi.small.goal.my.entry.TransferShapeEntity;
    ...
    private void getNotice() {
        ...
        XUtil.get(requestParams, this, new XUtil.XCallBackLinstener() {
            ...
            public void onSuccess(String result) {
                ...
                Gson gson = new Gson();
                List<NoticeEntity> data = gson.fromJson(Utils.getResult(result), new TypeToken<List<NoticeEntity>>() {
                }.getType());
    ...
    private void getDiagram() {
        ...
        XUtil.get(requestParams, this, new XUtil.XCallBackLinstener() {
            ...
            public void onSuccess(String result) {
                ...
                Gson gson = new Gson();
                String arrStr = Utils.getResult(result);
