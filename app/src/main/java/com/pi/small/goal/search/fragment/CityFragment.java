...
public class CityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currentView = inflater.inflate(R.layout.fragment_city, container, false);
...
//            hotAdapter.notifyDataSetChanged();
    ...
    private void GetHotData(String page, String r) {
        ...
        requestParams.addBodyParameter("city", Utils.UserSharedPreferences(getActivity()).getString("city", ""));
