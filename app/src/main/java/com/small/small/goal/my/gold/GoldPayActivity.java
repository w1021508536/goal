    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.left_image:
                Utils.showToast(GoldPayActivity.this, "支付取消");
            ...
            case R.id.wechat_layout:
                ...
                if (isHaveWeixin) {
                    ...
                    Utils.showToast(GoldPayActivity.this, "请先安装微信应用");
                }
...
//                Utils.showToast(PayActivity.this, result);
                if (result.equals("success")) {
                    Intent intent = new Intent();
                    intent.setClass(GoldPayActivity.this, PayDetailActivity.class);
                    ...
                    Utils.showToast(GoldPayActivity.this, "支付插件未安装");
                    Intent intent = new Intent();
                    setResult(Code.FailCode, intent);
                    finish();
                } else if (result.equals("unknown")) {
                    Utils.showToast(GoldPayActivity.this, "应用进程异常");
                    Intent intent = new Intent();
                    setResult(Code.FailCode, intent);
                    finish();
                }
            ...
            if (data.getStringExtra("password").length() == 6) {
                ...
                Utils.showToast(GoldPayActivity.this, "取消输入支付密码");
            }
        }
    }
    ...
    private void DynamicAim() {
        RequestParams requestParams = new RequestParams(Url.Url + Url.ChargeBean);
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (code.equals("0")) {
                        ...
                        Utils.showToast(GoldPayActivity.this, new JSONObject(result).getString("msg"));
                    }
