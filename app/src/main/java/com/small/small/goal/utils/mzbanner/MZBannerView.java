package com.small.small.goal.utils.mzbanner;
...
import com.small.small.goal.utils.mzbanner.transformer.CustomTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    public void setmIndicatorsBottom(int marginBottom) {
