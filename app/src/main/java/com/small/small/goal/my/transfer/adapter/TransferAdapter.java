package com.small.small.goal.my.transfer.adapter;
...
public class TransferAdapter extends BaseAdapter {
    ...
    public TransferAdapter(Context context, List<GoldEmpty> guessEmptyList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_list_transfer, parent, false);
        ...
        if (Double.valueOf(guessEmptyList.get(position).getAmount()) > 0) {
            ...
            viewHolder.moneyText.setText(guessEmptyList.get(position).getAmount());
            viewHolder.moneyText.setTextColor(context.getResources().getColor(R.color.text_hui));
        }
